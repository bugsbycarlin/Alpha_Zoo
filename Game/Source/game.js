...
class Game {
  constructor() {
    ...
    PIXI.Loader.shared
      ...
      .add("Art/Terrain/fence_post_v3.png")
      ...
      // .add("Art/Terrain/path_n_v1.png")
      // .add("Art/Terrain/path_ne_v1.png")
      // .add("Art/Terrain/path_e_v1.png")
      // .add("Art/Terrain/path_se_v1.png")
      // .add("Art/Terrain/path_s_v1.png")
      // .add("Art/Terrain/path_sw_v1.png")
      // .add("Art/Terrain/path_w_v1.png")
      // .add("Art/Terrain/path_nw_v1.png")
      // .add("Art/Terrain/path_c_v1.png")
