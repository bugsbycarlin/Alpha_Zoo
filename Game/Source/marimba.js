...
Game.prototype.makeMarimba = function(pen) {
  ...
  marimba.exterior = new PIXI.Sprite(PIXI.Texture.from("Art/Marimba/marimba.png"));
  ...
  marimba.exterior_grey = new PIXI.Sprite(PIXI.Texture.from("Art/Marimba/marimba_grey.png"));
